...
class SURGE_GenerateRamp(bpy.types.Operator):
    ...
    size: bpy.props.FloatProperty(
        name="", description="Size of the ramp", default=1024, min=0
    )
        ...
        # Thin.
            ...
            if self.angle != 360:
                ...
                if self.surf_enum != "Both":
                    obj.data.edges[1].select = True
                    obj.data.edges[
                        len(obj.data.edges) - (self.smoothness * 2)
                    ].select = True
                else:
                    obj.data.edges[1].select = True
                    obj.data.edges[2].select = True
